...
const PERSONALITIES = {
  explorer: {
    ...
    prompt: `You are the AI brain of a Raspberry Pi 5 mounted on a robot car. You have two primary sensors:
...
Your goal is to spend a short time (approx. 5-7 steps) exploring and mapping the room, then locate one of the corners of the room and park there.
